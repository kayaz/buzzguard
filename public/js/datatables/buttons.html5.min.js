...
(function(n) {
    ...
    D.ext.buttons.copyHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.copy", "Schowek")
        },
        action: function(a, c, d, b) {
            ...
            if (x.queryCommandSupported("copy")) {
                ...
                try {
                    ...
                    d.remove();
                    if (p) {
                        c.buttons.info(c.i18n("buttons.copyTitle", "Skopiuj do schowka"), c.i18n("buttons.copySuccess", {
                            1: "Skopiowano jeden wpis do schowka",
                            _: "Skopiowano %d wpisów do schowka"
                        }, a.rows), 2E3);
                        this.processing(!1);
                        return
                    }
